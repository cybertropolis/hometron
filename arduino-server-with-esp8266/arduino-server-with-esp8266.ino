...
char ssid[] = "Oi B212"; //VARIÁVEL QUE ARMAZENA O NOME DA REDE SEM FIO
char pass[] = "v87eSsjtJ2";//VARIÁVEL QUE ARMAZENA A SENHA DA REDE SEM FIO
...
void setup(){
  ...
  WiFi.config(IPAddress(192,168,1,55)); //COLOQUE UMA FAIXA DE IP DISPONÍVEL DO SEU ROTEADOR
...
void sendHttpResponse(WiFiEspClient client){
  ...
  client.println("<link rel='icon' type='image/png' href='http://blogmasterwalkershop.com.br/arquivos/artigos/sub_wifi/icon_mws.png'/>"); //DEFINIÇÃO DO ICONE DA PÁGINA
  ...
  client.println("<img alt='masterwalkershop' src='http://blogmasterwalkershop.com.br/arquivos/artigos/sub_wifi/logo_mws.png' height='156' width='700' />"); //LOGO DA MASTERWALKER SHOP
